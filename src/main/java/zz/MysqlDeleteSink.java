 ...
 */
public class MysqlDeleteSink extends AbstractSink implements Configurable {

    private Logger LOG = LoggerFactory.getLogger(MysqlDeleteSink.class);
    ...
    public Status process() throws EventDeliveryException {
        ...
        try {
            ...
            if (null != event) {
                ...
                String sql = MysqlSinkUtil.getSqlDelete(context, databaseName + "." + tableName, fields);
                LOG.info("sql是："+sql);
                actions.add(sql);
                //此处写你的业务逻辑 end
            } else {
